<div id="header-aside">
	<div id="header-aside-inner">
		...
		if ( is_user_logged_in() && buddyboss_is_bp_active() && $create_new_post_page && onesocial_get_option( 'write_post_button' ) ) {
                        ...
                        ?>
			<a href="<?php echo $href; ?>" class="header-button boss-tooltip boss-write-story-icon" data-tooltip="<?php _e( 'Write a Testimony', 'onesocial' ); ?>">
				<i class="bb-icon-write"></i>
			</a><?php }
		?>
	<a href="<?php echo site_url( 'help-pages' ); ?>" class="header-button boss-tooltip help-page" data-tooltip="<?php _e( 'Help', 'onesocial' ); ?>">
		<strong>?</strong>
	</a>
