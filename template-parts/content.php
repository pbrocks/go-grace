...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php if ( is_search() || is_archive() || is_home() ) : ?>
		...
		<div class="posts-stream">
			<div class="loader"><?php esc_html_e( 'Loading...', 'onesocial' ); ?></div>
		</div>
		...
		<div class="header-area">
			<div class="home-post-header">
				...
				<a class="url fn n" href="<?php echo $user_link; ?>" title="<?php echo get_the_author(); ?>" rel="author">
					...
					<br><span>
					<?php echo esc_attr( human_time_diff( get_the_time( 'U' ) ), current_time( 'timestamp' ) ) . ' ago '; ?>
					<i style="font-size: 1rem;" class="fa fa-circle-o-notch fa-spin fa-3x fa-fw"> </i> 
					<?php echo esc_html( boss_estimated_reading_time( $post_content ) ); ?>
				</span>
			</div>
		</div>			<?php
		$header_class = '';
			...
			<div class="entry-content entry-summary">
				...
				<footer class="entry-meta">
					<div class="footer-meta">
						<a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'onesocial' ), the_title_attribute( 'echo=0' ) ) ); ?>" class="read-more"><?php _e( 'Read more...', 'onesocial' ); ?></a>
					</div>
		...
		<div class="container">
			<div class="inner">
				...
				<div class="details table-cell">
					...
					<?php include( get_stylesheet_directory() . '/buddypress/members/single/social-stuff.php' ); ?>
